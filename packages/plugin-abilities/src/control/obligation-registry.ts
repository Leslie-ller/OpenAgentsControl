...
const BUILTIN_OBLIGATIONS: Record<string, ObligationDefinition[]> = {
  code_change: [
    ...
    { key: 'commit_if_required', severity: 'soft', tags: ['commit'] },
    {
      ...
      severity: 'soft',
      tags: ['requirements-checked'],
      signals: ['requirements_checked'],
      requiredFields: ['acceptance_criteria'],
      description: 'Requested scope and acceptance criteria were explicitly checked.',
    },
    {
      key: 'affected_files_identified',
      severity: 'soft',
      tags: ['affected-files'],
      signals: ['affected_files_identified'],
      requiredFields: ['affected_files'],
      description: 'Affected files and surfaces were identified.',
    },
    {
      key: 'implementation_recorded',
      severity: 'soft',
      tags: ['implementation-recorded'],
      signals: ['implementation_recorded'],
      requiredFields: ['changed_files'],
      description: 'Implementation changes were recorded in structured form.',
    },
    {
      key: 'review_completed',
      severity: 'soft',
      tags: ['review-completed'],
      signals: ['review_completed'],
      requiredFields: ['verdict'],
      description: 'Code review was completed before completion claim.',
    },
    {
      key: 'verification_evidence_recorded',
      severity: 'soft',
      tags: ['verification-evidence'],
      signals: ['verification_evidence_recorded'],
      requiredFields: ['commands', 'exit_codes'],
      description: 'Validation evidence was recorded with commands and exit codes.',
    },
  ],
  paper_screening: [
